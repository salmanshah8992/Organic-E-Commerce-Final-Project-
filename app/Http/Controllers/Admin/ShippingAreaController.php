...
class ShippingAreaController extends Controller
{
    ...
    public function createDivision(){
        ...
        return view('backend.ship_division.create',compact('divisions'));
    }
    ...
    public function divisionEdit($division_id){
        ...
        return view('backend.ship_division.edit',compact('division'));
    }
    ...
    public function districtCreate(){
        ...
        return view('backend.ship_distict.create',compact('districts','divisions'));
    }
    ...
    public function districtEdit($district_id){
        ...
        return view('backend.ship_distict.edit',compact('divisions','district'));
    }
    ...
    public function stateCreate(){
        ...
        $divisions = ShipDivision::orderBy('division_name','ASC')->get();
        return view('backend.ship_state.create',compact('states','divisions'));
    }
    ...
    public function stateEdit($state_id){
        ...
        return view('backend.ship_state.edit',compact('divisions','state'));
    }
