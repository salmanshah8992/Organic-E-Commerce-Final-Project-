              ...
              <table id="datatable1" class="table display responsive nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('district-edit/'.$item->id) }}" class="btn btn-sm btn-primary" title="edit data"> <i class="fa fa-pencil"></i></a>

                      <a href="{{ url('district-delete/'.$item->id) }}" class="btn btn-sm btn-danger" id="delete" title="delete data"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
          ...
          <div class="card">
            ...
            <form action="{{ route('district-store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="district_name" value="{{ old('district_name') }}" placeholder="Enter district_name"><br>
                  @error('district_name')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
