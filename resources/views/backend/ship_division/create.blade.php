              ...
              <table id="datatable1" class="table display responsive nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('division-edit/'.$item->id) }}" class="btn btn-sm btn-primary" title="edit data"> <i class="fa fa-pencil"></i></a>

                      <a href="{{ url('division-delete/'.$item->id) }}" class="btn btn-sm btn-danger" id="delete" title="delete data"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
          ...
          <div class="card">
            ...
            <form action="{{ route('division-store') }}" method="POST">
                ...
                <div class="form-layout-footer">
                  <button type="submit" class="btn btn-info">Division Create</button>
