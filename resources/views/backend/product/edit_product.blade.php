                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2-show-search" data-placeholder="Select One" name="subcategory_id">
                          ...
                          <option value="{{ $Subcat->id }}" {{ $Subcat->id == $product->subcategory_id ? 'selected' :'' }}>{{ ucwords($Subcat->subcategory_name_en) }}</option>
                          @endforeach
                        </select>
          ...
          @foreach ($multiImgs as $img)
              <div class="col-md-3">
                <div class="card" >
                  ...
                  <div class="card-body">
                    <h5 class="card-title">
                      <a href="{{ url('product/multiimg/delete/'.$img->id) }}" class="btn btn-sm btn-danger" id="delete" title="delete data">Delete</a>
                    </h5>
                    <p class="card-text">
                      <div class="form-group">
                        <label class="form-control-label">Change Image<span class="tx-danger">*</span></label>
