            ...
            <form action="{{ route('state-update') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text"  value="{{ $state->district->district_name }}" placeholder="Enter state_name" readonly ><br>
                  </div>

                <div class="form-group">
                  <label class="form-control-label">state Name: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="state_name" value="{{ $state->state_name }}" placeholder="Enter state_name"><br>
                  @error('state_name')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
