                            ...
                            <div class="topbar-right d-flex justify-content-end">
                                ...
                                <div class="dropdown account">
                                    ...
                                    <div class="dropdown-menu">
                                        @auth
                                            <div class="item">
                                                <a href="{{ route('user.profile') }}"
                                                    title="Log in to your customer account"><i class="fa fa-cog"></i>My
                                                    Order</a>
                                            </div>
                                        ...
                                        @auth
                                            <div class="item">
                                                <a href="{{ route('view.wishlist') }}" title="My Wishlists"><i
                                ...
                                <div class="dropdown language">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="{{ asset('frontend') }}/img/language-en.jpg"
                ...
                <div class="container">
                    <div class="row margin-0">
                        <div class="col-lg-2 col-md-2 col-sm-12 padding-0">
                            ...
                            <div class="logo">
                                <a href="{{ url('/') }}">
                                    <img class="img-responsive" src="{{ asset('frontend') }}/img/logo.png"
                                        alt="Logo">
                                </a>
                            </div>
                                                ...
                                                @foreach ($categorys as $item)
                                                    <li class="has-image">
                                                        <a href="{{ route('category.product', $item->id) }}"
                                                            title="{{ $item->category_name_en }}">{{ $item->category_name_en }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 padding-0">
                            ...
                            <div class="block-cart dropdown">
                                <div class="cart-title">
                                    ...
                                    <span class="cart-count"><span class="count"
                                            id="cartQty"></span></span>
                                </div>
                                    ...
                                    <div class="cart-content">
                                        <table>
                                            <tbody>
                                                ...
                                                <tr class="total">
                                                    <td>Total:</td>
                                                    <td colspan="2"><span class="sign">৳</span><span
                                                            class="value" id="cartSubTotal"></span></td>
                                                </tr>
                            ...
                            <div class="block text">
                                <div class="block-content">
                                    <a href="home-2.html" class="logo-footer">
                                        <img class="img-responsive" src="http://127.0.0.1:8000/frontend/img/logo.png"
                                            alt="Logo">
                                    </a>
                                ...
                                <div class="block-content">
                                    <div class="contact">
                                        ...
                                        <div class="item d-flex">
                                            ...
                                            <div>
                                                <span><a
                                                        href="mailto:support@domain.com">support@organicecommerce.com</a><br><a
                                                        href="mailto:contact@organicecommerce.com">contact@organicecommerce.com</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
